...
require_once("../clase/conexion.php"); 
 ...
 $adminis=$usuario->get_admin();  // llamamos al metodo get_ususario de userModulo
 $estu=$usuario->get_estudiante();  // llamamos al metodo get_ususario de userModulo
  $profe=$usuario->get_profesores();
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><h2><b><?php echo  $estu[0]["administradores"]; ?></b></h2></div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><h2><b><?php echo  $adminis[0]["administradores"]; ?></b></h2></div>
                    </div>
                    <div class="col-auto">
                      <i class="fas fa-users fa-2x text-gray-300"></i>
                    </div>
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><h2><b><?php echo  $profe[0]["administradores"]; ?></b></h2></div>
                    </div>
                    <div class="col-auto">
                      <i class="fas fa-users fa-2x text-gray-300"></i>
                    </div>
