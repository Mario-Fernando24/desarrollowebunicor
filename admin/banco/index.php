...
require_once("../../clase/conexion.php"); 
 ...
 $datos=$usuario->get_Banco_consulta();  // llamamos al metodo get_ususario de userModulo

 if(isset($_POST["grabar"]) and $_POST["grabar"]=="jum"){ // que si se enviaron los datos
  require_once("../../clase/ClaseBanco.php"); // llamo al modulo usuario
  $usuario=new Banco(); // ccreo mi instancia de usuario
  $usuario->editar_banco(); // llamo al metodo de agregar programa por medio de mi instancia
  exit(); // cierro
}
  ?>
<!DOCTYPE html>
...
<body id="page-top">
  ...
  <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">  <!-- colomna cuado el dispositivo seal grande tenga 8 columna aho de 8 y cuando el dispositovo sea pequeño que me muestre todo la pantalla completa-->
    <h3> <b>Banco de Pregunta</b> <a href="crear.php"><button class="btn btn-success">Nuevo</button></a></h3>
        <?php
   if(isset($_GET['m'])){
    switch ($_GET['m']){
      case '1':
        ...
        <div class="alert alert-danger">
         <strong>Eliminado!</strong>Pregunta
        </div>
        <?php 
        break;
      case '2':
        ...
        <strong>Exitoso!</strong>Pregunta creado con exito
         </div>  
        <?php
        break;
    } }
                  ...
                  <div class="row">
                     <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                      ...
                      <td>
                       ...
                       <input type="hidden" name="grabar" value="jum">
