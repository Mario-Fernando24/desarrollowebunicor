...
<body id="page-top">
  ...
  <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">  <!-- colomna cuado el dispositivo seal grande tenga 8 columna aho de 8 y cuando el dispositovo sea pequeño que me muestre todo la pantalla completa-->
    <h3> <b>Listado de usuario general</b> <a href="crear.php"><button class="btn btn-success">Nuevo</button></a></h3>
        <?php
   if(isset($_GET['m'])){
    switch ($_GET['m']){
      case '1':
        ...
        <div class="alert alert-danger">
         <strong>Eliminado!</strong> Usuario
        </div>
        <?php 
        break;
      case '2':
        ...
        <strong>Exitoso!</strong> usuario creado con exito
         </div>  
        <?php
        break;
         case '3':
        ?>
        <div class="alert alert-success">
        <strong>Exitoso!</strong> usuario <b>editado</b>
         </div>  
        <?php
        break;
    } }
