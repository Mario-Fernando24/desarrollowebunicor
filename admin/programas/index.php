...
require_once("../../clase/conexion.php"); 
 ...
 $datos=$usuario->get_Programa();  // llamamos al metodo get_ususario de userModulo
  ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body id="page-top">
  ...
  <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">  <!-- colomna cuado el dispositivo seal grande tenga 8 columna aho de 8 y cuando el dispositovo sea pequeño que me muestre todo la pantalla completa-->
    <h3> <b>Listado de Programas</b> <a href="crear.php"><button class="btn btn-success">Nuevo</button></a></h3>
        <?php
   if(isset($_GET['m'])){
    switch ($_GET['m']){
      case '1':
