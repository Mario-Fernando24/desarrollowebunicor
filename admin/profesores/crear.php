...
if(isset($_SESSION["id"]) && $_SESSION["tipo_persona"]==1){//<!-- si existe la variable session me muestra todo 
...
if(isset($_POST["grabar"]) and $_POST["grabar"]=="si"){ // que si se enviaron los datos
  ...
  $usuario->agregar_docente(); // llamo al metodo de agregar programa por medio de mi instancia
  exit(); // cierro
}
?>
<!DOCTYPE html>
   ...
   if(isset($_GET['m'])){
    switch ($_GET['m']){
      ...
      case '2':
        ...
        <strong>Exitoso!</strong> Docente creado con exito
         </div>  
        <?php
        break;
    } }
  ?> 
                  <h3 class="box-title"><b>Crear Docente</b></h3>
