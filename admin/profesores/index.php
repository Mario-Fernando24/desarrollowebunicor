...
require_once("../../clase/conexion.php"); 
 if(isset($_SESSION["id"]) && $_SESSION["tipo_persona"]==1){//<!-- si existe la variable session me muestra todo el  formulario-->
  ...
  $usuario=new Docente(); // ccreo mi instancia de usuario
 $datos=$usuario->get_Docente();  // llamamos al metodo get_ususario de userModulo
  ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body id="page-top">
  ...
  <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">  <!-- colomna cuado el dispositivo seal grande tenga 8 columna aho de 8 y cuando el dispositovo sea pequeño que me muestre todo la pantalla completa-->
    <h3> <b>Listado de profesores</b> <a href="crear.php"><button class="btn btn-success">Nuevo</button></a></h3>
        <?php
   if(isset($_GET['m'])){
    switch ($_GET['m']){
      case '1':
        ...
        <div class="alert alert-danger">
         <strong>Docente</strong> eliminado
        </div>
        <?php 
        break;
      case '2':
        ...
        <strong>Docente</strong>  creado con exito
         </div>  
        <?php
        break;
         case '3':
        ?>
        <div class="alert alert-success">
        <strong>Docente</strong>  <b>editado</b>
         </div>  
        <?php
        break;
    } }
    ...
    <!--aqui va el buscador-->
                  ...
                  <div class="row">
                     <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                      ...
                      <td><?php echo $datos[$i]["num_identidad"] ?></td>  
